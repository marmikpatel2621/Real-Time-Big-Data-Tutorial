...
//        VideoDisplay<MBFImage> display = VidegoDisplay.createVideoDisplay(video);
        int j=0;
    ...
    public static void MainFrames() throws IOException, InterruptedException {
        ...
        for(int i=0; i<mainPoints.size(); i++){
            if(((mainPoints.get(i))/max < 0.1) || i==0){
