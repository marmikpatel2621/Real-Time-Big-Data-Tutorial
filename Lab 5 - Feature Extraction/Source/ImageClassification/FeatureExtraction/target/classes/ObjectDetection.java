...
//    private RenderMode renderMode = RenderMode.SQUARE;
            ...
            if (this.matcher3.findMatches(kpl)
                ...
                try {
                    ...
                    if (modelImage3.getBounds().transform(boundsToPoly).isConvex()) {
                        ...
                        renderer.drawText(new AttributedString("Stomach cancer cells"),(int)this.modelImage3.getBounds().getTopLeft().getX()+25,10);
                        if (count3 <= 10){
    ...
    public void LoadReferenceObject() {
        ...
        try {
            modelImage1 = ImageUtilities.readMBF(new File("data/brain1.jpg"));
            modelImage2 = ImageUtilities.readMBF(new File("data/lung1.jpg"));
            modelImage3 = ImageUtilities.readMBF(new File("data/stomach1.jpg"));
            modelImage4 = ImageUtilities.readMBF(new File("data/throat1.jpg"));
        } catch (IOException e) {
            e.printStackTrace();
        }
